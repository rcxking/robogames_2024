...
#define DEFAULT_TIMEOUT (2000)
	...
	bool OrdlidarDriver::Connect()
	{
...

		{
			...
			delay(200);	//Wait for the data to be received before you know some status in advance
		}
	...
	bool OrdlidarDriver::Activate(void)
	{
		...
		delay(400);						//Prevent continuous call, which will cause the radar to be unable to process
		request.head_flag = HEAD_FLAG;
